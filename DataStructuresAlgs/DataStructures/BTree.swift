...
class BTree<T: Comparable> {
    ...
    static func test() {
        ...
        bTree.traverse()
        debugPrint(bTree.search(key: 10))
        debugPrint(bTree.search(key: 30))
        debugPrint(bTree.search(key: 50))
        debugPrint(bTree.search(key: 90))
        debugPrint(bTree.search(key: 100))
    }
}
